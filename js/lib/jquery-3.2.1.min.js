...
!(function (a, b) {
  ...
  r.extend({
    ...
    r.fn.extend({
      ...
      containerInner: function (a) {
        return r.isFunction(a)
          ? this.each(function (b) {
              r(this).containerInner(a.call(this, b));
            })
          : this.each(function () {
              var b = r(this),
                c = b.contents();
              c.length ? c.containerAll(a) : b.append(a);
            });
      },
      container: function (a) {
        var b = r.isFunction(a);
        return this.each(function (c) {
          r(this).containerAll(b ? a.call(this, c) : a);
        });
      },
      uncontainer: function (a) {
        return (
          this.parent(a)
            .not('body')
            .each(function () {
